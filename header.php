...
<?php
	...
	if(isset($_POST['registerClick']))
	{
		...
		else
		{
			...
			{
			$query="insert into user_reg (fname,lname,gender,contact,email,password,add1) value('$fnm','$lnm','$gender','$contact','$email','$dbpass','$add1')";
...
<html lang="en">
  <head>
    ...
    <title>Art Unlimited | <?php echo $title; ?></title>
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#">Art Unlimited</a>
			</div>
			<div>
