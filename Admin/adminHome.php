...
<?php
		...
		if(isset($_POST['reach_info']))
		{
			...
			$query="update reach_us set nm='".$_POST['reach_nm']."', add1='".$_POST['reach_add1']."', city='".$_POST['reach_city']."', zipcode='".$_POST['reach_zip'].",contact_no='".$_POST['contact_no']."' where uid=1";
			mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
