		...
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group">
					...
					<p> ART GALLERIES provide their artists with space to exhibit their art and the artists <br> with art reality 
					 not only do the large mojority og galleries already have more art and artits than they can handle, <br>but they are also continually contacted by new artists looking for representation</p>
				</div>
			</form>
		</div>
	</div>
